...
def build_dataloader(cfg, batch, img_path, stride=32, rect=False, names=None, rank=-1, mode='train'):
    ...
    workers = cfg.workers if mode == 'train' else cfg.workers * 2 #和下面batch对应，val时batch扩大二倍
    ...
    generator = torch.Generator() #torch.Generator(6148914691236517205 + RANK) 同样的效果
...
def load_inference_source(source=None, transforms=None, imgsz=640, vid_stride=1, stride=32, auto=True, single_channel=False):
    """
    TODO: docs
    """
    # source
