...
class TaskAlignedAssigner(nn.Module):
    ...
    def __init__(self, topk=13, num_classes=80, alpha=1.0, beta=6.0, eps=1e-9, roll_out_thr=0):
        ...
        self.alpha = alpha #质量评价系数中score权重
        self.beta = beta#质量评价系数中iou权重
        self.eps = eps
    ...
    def forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt):
        ...
        mask_pos, align_metric, overlaps = self.get_pos_mask(pd_scores, pd_bboxes, gt_labels, gt_bboxes, anc_points, 
                                                             mask_gt) # 获取L2距离最近的K个anchor,
        #计算top k个anchor iou的均值和方差，然后使用均值和方差的组合，选定阈值
    ...
    def get_pos_mask(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes, anc_points, mask_gt):
        # get anchor_align metric, (b, max_num_obj, h*w)， align_metrix 质量评价矩阵，综合了scores和iou
