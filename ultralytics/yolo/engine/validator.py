...
class BaseValidator:
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, logger=None, args=None, override=None):
        """
        ...
        self.args = get_cfg(DEFAULT_CFG, overrides=override)
    ...
    def __call__(self, trainer=None, model=None):
        ...
        for batch_i, batch in enumerate(bar):
            ...
            # print(batch['img'].shape) # bs, 1, 512, 256
            # preprocess
            with dt[0]:
