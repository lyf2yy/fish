...
class YOLO:
    ...
    def __init__(self, model='yolov8n.pt', type='v8', pruneTrain=False) -> None:
        """
    ...
    def _new(self, cfg: str, verbose=True):
        ...
        self.cfg_dict = yaml_load(self.cfg, append_filename=True)  # model dict
        self.task = guess_model_task(self.cfg_dict)
        self.ModelClass, self.TrainerClass, self.ValidatorClass, self.PredictorClass = self._assign_ops_from_task()
        self.model = self.ModelClass(self.cfg_dict, verbose=verbose and RANK == -1)  # initialize
    ...
    def export(self, imgsz, **kwargs):
        ...
        return exporter(imgsz=imgsz, model=self.model)
